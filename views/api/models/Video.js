...
module.exports = {
  ...
  afterCreate: function(video, cb) {
    ...
    sails.log.info("Video#afterCreate: making thumbnail for video");
  ...
  updateMetadata: function (video_title, callback) {
  	sails.log.info("updateMetadata: requesting: ", "http://thetvdb.com/api/GetSeries.php?seriesname=" + video_title)
